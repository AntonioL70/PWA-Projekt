...
if (!$kategorija) {
    die("Kategorija nije definirana.");
}
?>
...
<section class="container py-5">
    <h2 class="section-title text-center mb-4"><?php echo htmlspecialchars($kategorija); ?></h2>
    <div class="row row-cols-1 row-cols-md-4 g-4">
        <?php
        $stmt = $conn->prepare("SELECT * FROM clanci WHERE kategorija = ? ORDER BY datum_objave DESC");
